    ...
    override fun onClick(v: View) {
       when (v.id){
           ...
           R.id.btn_move_activity_data -> {
            ...
            moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Mukhammad Haykal Machrus")
            moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE, 17)
            startActivity(moveWithDataIntent)
           }
           R.id.btn_move_with_object -> {
               val person = Person(
                   "Mukhammad Haykal Machrus",
                   17,
                   "Machrusaja04@gmail.com",
                   "Magelang"
               )
